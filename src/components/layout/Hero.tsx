    ...
    return (
        <div className="flex relative" >
            <div className="basis-1/2" >
                <img src="https://img.freepik.com/premium-photo/two-young-beautiful-women-colorful-summer-clothes_149155-3631.jpg?ga=GA1.1.1380726810.1733336188&semt=ais_incoming" alt="#" />
            </div>
